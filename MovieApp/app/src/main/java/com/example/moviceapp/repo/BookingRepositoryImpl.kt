...
interface BookingRepository {
    ...
    suspend fun getBookings(token: String): APIResult<List<Booking>>
}
...
class BookingRepositoryImpl @Inject constructor(
    ...
    override suspend fun getBookings(token: String): APIResult<List<Booking>> =
        service.getBookings(token).toAPIResult()
}
